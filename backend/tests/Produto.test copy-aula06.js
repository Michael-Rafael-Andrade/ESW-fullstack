...
describe("Produto", () => {
    ...
    it("deve ser criado com os atributos corretos", () => {
        ...
        expect(p.descricao).toBe("Camisa azul"); //toBe(coloca o valor esperado)
    ...
    it("deve lançar erro se nome não for definido", () => {
    ...
    it("deve lançar erro se for um número negativo para aumentar o estoque", () => {
        const p = new Produto("Calça", "Calça jeans", 129.9, 5);
        expect(() => p.aumentarEstoque(-1)).toThrow("Quantidade inválida para aumentar estoque");
    });
...
// Comentários dos código
/*

beforeEach() // Vai executar antes dos casos de testes

afterEach() // Vai executar depois de cada caso de uso

beforeAll() // Vai executar antes de todos os caso de testes

afterAll() // Vai executar depois de todos os caso de testes
